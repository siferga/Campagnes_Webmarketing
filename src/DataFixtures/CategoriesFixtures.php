...
{
    //creer  les dependances dans m;les datas
    //Creation de compteur avec propieté counter. >Initialiser à 1.
    private $counter = 1;
    ...
    public function createCategory(string $name, Categories $parent = null, ObjectManager $manager)
    {
        ...
        //Stocké la reference. Mise en memoire avec methode addReference
